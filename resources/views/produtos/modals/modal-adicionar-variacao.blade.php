<div class="modal fade" id="modal_variacao" tabindex="-1" role="dialog" aria-labelledby="modal_variacao_label"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_variacao_label">Adicionar Variação</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="form_variacao" class="form-horizontal" method="POST" action="{{ route('variacoes.store') }}">
